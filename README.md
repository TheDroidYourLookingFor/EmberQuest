...
**Loot, affixes, and item sets.** Random gear drops with prefix/suffix affix rolls — including D&D ability-score affixes (STR/DEX/CON/INT/WIS/CHA) that now appear on dropped gear — three-piece set bonuses, weapon procs, and six rarity tiers: Common (white), Uncommon (green), Rare (blue), Epic (purple), Legendary (orange), and Mythic (red), plus crafted Runewords. Higher tiers roll more affixes and carry guaranteed ability bonuses; Mythic is the rarest chase tier. Equipment slots cover weapon, off-hand, chest, legs, feet, and charm.
